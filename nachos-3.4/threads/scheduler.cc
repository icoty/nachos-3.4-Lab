...
Scheduler::ReadyToRun (Thread *thread)
{
    ...
    // modify by yangyu
#ifdef SCHED_PRIORITY  // 基于优先级可抢占调度策略,自己添加的宏
...
Thread *
Scheduler::FindNextToRun (bool bySleep)
{
    if(bySleep){ // called by threadsleep
...
Scheduler::Run (Thread *nextThread)
{
    ...
    if (threadToBeDestroyed != NULL) {
        ...
        currentThread->initUserRegister();
        printf("oldT:%llx newT:%llx\n",threadToBeDestroyed,currentThread);
#endif*/
